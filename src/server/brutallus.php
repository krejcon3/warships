...
if (strlen($hash) > 0) {
    ...
    echo '
        ...
        <html lang="cz">
            <head>
                <meta charset="UTF-8">
                <title>Warships [Brutallus]</title>
            <link rel="stylesheet" type="text/css" href="./brutallus/style.css">
            </head>
            <body>
                <div id="player_id" data-hash="' . $player_hash . '"></div>
                <canvas id="canvas" width="500" height="500"></canvas>
                <script src="./brutallus/jquery-3.3.1.min.js"></script>
                <script src="./brutallus/script.js"></script>
            </body>
        </html>
    ';
